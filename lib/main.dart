          ...
          children: <Widget>[
            ...
            Row(children: [
              ...
              ElevatedButton(
                  ...
                  //child: Text(CommonCtrl.to.sss.value)),
                  child: const Text('builder Test Page')),
              const SizedBox(height: 10),
              ElevatedButton(
                  onPressed: () async {
                    //await compute(CommonCtrl.to.computeTest, 1);
                ...
                ElevatedButton(
                    onPressed: () async {
                      ...
                      String encoded = stringToBase64
                          .encode(all); // dXNlcm5hbWU6cGFzc3dvcmQ=
